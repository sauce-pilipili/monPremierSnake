window.onload = function () {
    ...
    function Snake(body, direction) {
        ...
        this.setDirection = function (newDirection) {
            var permittedDirection;
            switch (this.direction) {
                case "left":
                case "right":
                    permittedDirection = ["up", "down"];
                    break;
                case "down":
                case "up":
                    permittedDirection = ["left", "right"];
                    break;
                default:
                    throw ("Invalid direction");

            }
            if (permittedDirection.indexOf(newDirection) > -1) {
    ...
    function Apple(position) {
        ...
        this.setNewPosition = function () {
            var newX = Math.round(Math.random() * (widhtInBlock - 1));
